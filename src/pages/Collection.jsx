        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' :'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'cord'} onChange={toggleCategory}/>Cord Sets Collections
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'summer'} onChange={toggleCategory}/>Summer Collections
            </p>
            <p className='flex gap-2'>
